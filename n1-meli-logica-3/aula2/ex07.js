...
const palavras = ["elefante", "casa", "rede"]
    ...
    for(let i = 0; i <cacaPalavras.length; i++){
        ...
        console.log(`o join juntou ${cacaPalavras}`)
        for(let j = 0; j < palavras.length; j++){
            if (cacaPalavras[i].indexOf(palavras[j]) > -1){
                console.log(
                    `A palavra ${palavras[j]} esta na linha ${ i + 1} e comeca na coluna ${cacaPalavras[i].indexOf(palavras[j]) +1}`
                )
            }
    ...
    //console.log(cacaPalavras.indexOf('c'))
//console.log(palavras.indexOf('rede'))
//
...
// for(let i=0; i < cacaPalavras.length; i++){
//     console.log(i)
//     for(let j=0; j < cacaPalavras[i].length;j++){
//         console.log(j)
//     }
// }
